...
<a id="workflow-spec-file-injection"></a>
...
> For more information, see [Submit via CLI](../submission.md#submit-cli).
...
#### Using Local Input Datasets (Example)

| Input          | Reference                           |
|----------------|-------------------------------------|
| `test/folder`  | `{{input:0}}/dataset_name/folder`   |
| `test/folder2` | `{{input:1}}/dataset_name/folder2`  |
| `file.txt`     | `{{input:2}}/dataset_name/file.txt` |
