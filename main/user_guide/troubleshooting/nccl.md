...
For more details, see the [official NCCL documentation](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/index.html).
...
![Task Status and Exit Code Example](user_guide/troubleshooting/nccl/workflow_overview.png)
...
| ![Task Logs Example](user_guide/troubleshooting/nccl/task_logs_1.png)   | ![Logs Line Example](user_guide/troubleshooting/nccl/task_logs_2.png)   |
|-------------------------------------------------------------------------|-------------------------------------------------------------------------|
...
![Resource Usage Dashboard Example](user_guide/troubleshooting/nccl/resource_usage.png)
...
For more details, see [Synchronizing Training Start Time (Optional)](../how_to/training/multi_node.md#training-multi-node-sync).
...
For more details, see [NCCL Parameters](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html).
...
For more information, see [torch.distributed.init_process_group](https://docs.pytorch.org/docs/stable/distributed.html#torch.distributed.init_process_group).
...
For a comprehensive guide on implementing fault-tolerant training with automatic task rescheduling and checkpoint resumption, see [Fault-Tolerant Training with Rescheduling](../how_to/training/reschedule_backend_errors.md#training-reschedule).
...
* [PyTorch Elastic Documentation](https://docs.pytorch.org/docs/stable/elastic/run.html)
* [NCCL Tests Repository](https://github.com/NVIDIA/nccl-tests)
* [Debugging PyTorch Distributed Applications](https://docs.pytorch.org/docs/stable/distributed.html#debugging-torch-distributed-applications)
