...
After configuring [pools](pool.md#pool), you can enable advanced scheduling features using the [KAI scheduler](https://github.com/NVIDIA/kai-scheduler). This configuration controls how workflows compete for resources, enabling co-scheduling, preemption, and fair sharing across teams.
...
> **Note**
>
> For detailed configuration fields, see [Resource Constraint](../references/configs_definitions/pool.md#pool-config-resource-constraint) in the API reference.
...
#### SEE ALSO
- Learn more about [KAI scheduler](https://github.com/NVIDIA/kai-scheduler)
- Learn more about [scheduling in OSMO](../../user_guide/resource_pools/scheduling/index.md#concepts-priority)
