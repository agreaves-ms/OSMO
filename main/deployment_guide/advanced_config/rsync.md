...
> **Note**
>
> For detailed configuration fields and defaults, see [Rsync Plugin](../references/configs_definitions/workflow.md#rsync-plugin).
...
#### SEE ALSO
- Learn more about Rsync in OSMO at [Interactive Workflows](../../user_guide/workflows/interactive/rsync.md#workflow-interactive-rsync)
