...
Pod templates define how workflow tasks execute as Kubernetes pods. After configuring [pools](pool.md#pool) and [resource validation](resource_validation.md#resource-validation), create pod templates to specify scheduling constraints, security policies, and resource allocations that apply across your pools.
...
Pod templates use the standard [Kubernetes PodSpec](https://kubernetes.io/docs/concepts/workloads/pods/#pod-templates) format with OSMO enhancements:
...
> **Note**
>
> For detailed configuration fields and all available variables, see [/api/configs/pod_template](../references/configs_definitions/pod_template.md#pod-template-config) in the API reference.
