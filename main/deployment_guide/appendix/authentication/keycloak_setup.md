...
<a id="keycloak-roles-group-management"></a>

<a id="keycloak-setup"></a>
...
<a id="keycloak-assign-roles-to-groups"></a>
...
<a id="keycloak-assign-users-to-groups"></a>
...
<a id="identity-provider-mappings"></a>
...
For more information, see the [Keycloak documentation](https://www.keycloak.org/docs/latest/server_admin/index.html#_mappers).
...
1. **Verify Role Policy in OSMO**:
   ...
   - Follow the steps in [Troubleshooting](roles_policies.md#troubleshooting-roles-policies).
2. **Verify Role Names**:
   - Pool access roles must start with `osmo-` prefix (See [Role Naming for Pools](roles_policies.md#role-naming-for-pools)).
...
4. **Verify Group Membership**:
   ...
   - If using IdP Mappings (see [Configuring Identity Provider Mappings](#identity-provider-mappings)):
...
- [Authentication Flow](authentication_flow.md) for authentication flow details
